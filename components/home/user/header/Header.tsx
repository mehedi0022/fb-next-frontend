  ...
  return (
    <>
      <header
        ...
        style={{
          background:
            "linear-gradient(135deg, #2d1b4e 0%, #1a1a3e 40%, #1e2a5e 100%)",
        }}>
        <div className="container mx-auto">
          <div className="flex items-center h-14 bg-white/5 rounded-2xl px-5 border border-white/10 backdrop-blur-sm">
            {/* Logo */}
            ...
            {/* Desktop Nav */}
            <nav className="hidden lg:flex items-center justify-self-center gap-1 bg-black/30 rounded-xl px-2 py-1.5 mx-auto">
        ...
        {isMenuOpen && (
          <>
            ...
            <motion.div
              ...
              style={{
                background:
                  "linear-gradient(160deg, #2d1b4e 0%, #1a1a3e 50%, #1e2a5e 100%)",
              }}>
              {/* Drawer Header */}
